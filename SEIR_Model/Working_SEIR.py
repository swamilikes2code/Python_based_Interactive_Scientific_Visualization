...
def deriv(y, t, N, beta_A_uk, beta_A_k, beta_S_nh, beta_S_h, gamma, gamma_hosp, nat_death, death_rate_S, death_rate_hosp, E_to_I_forA, E_to_I_forS, return_rate, sd, test_rate):
    ...
    dIs_h_dt = (hosp*Is_nh)-(hcd*nat_death*Is_h)-(hcr*death_rate_hosp*Is_h)-(gamma_hosp*Is_h)
...
ret = odeint(deriv, y0, t, args=(N, beta_A_uk, beta_A_k, beta_S_nh, beta_S_h,  gamma, gamma_hosp, nat_death, death_rate_S, death_rate_hosp, E_to_I_forA, E_to_I_forS, return_rate, sd, test_rate))
S, E, Ia_uk, Ia_k, Is_nh, Is_h, R, D = ret.T
sourcePops=ColumnDataSource(data=dict(time=t, S=S/1000, E=E/1000, Ia_uk=Ia_uk/1000, Ia_k=Ia_k/1000, Is_nh=Is_nh/1000, Is_h=Is_h/1000, R=R/1000, D=D/1000))
...
pops.line('time', 'Ia_k', source=sourcePops, legend_label="Known Symptomatic Infected", line_width=2, color='yellow', line_dash=[2,2])
...
def update_data(attr, old, new):
    ...
    ret = odeint(deriv, y0, t, args=(N, A_infect_rate, beta_A_k, S_infect_rate, beta_S_h, recov_rate, gamma_hosp, nat_death, death_rate, death_rate_hosp, E_to_I_forA, E_to_I_forS, return_rate, sd, test_rate))
    S, E, Ia_uk, Ia_k, Is_nh, Is_h, R, D = ret.T
    sourcePops.data=dict(time=t, S=S/1000, E=E/1000, Ia_uk=Ia_uk/1000, Ia_k=Ia_k/1000, Is_nh=Is_nh/1000, Is_h=Is_h/1000,  R=R/1000, D=D/1000)

updates=[S_infection_rate_slide, social_distancing, recovery_slider, death_rate_slide, testing_rate, A_infection_rate_slide]
for u in updates:
    u.on_change('value', update_data)
widgets=column(A_infection_rate_slide, S_infection_rate_slide, social_distancing, recovery_slider, death_rate_slide, testing_rate)
