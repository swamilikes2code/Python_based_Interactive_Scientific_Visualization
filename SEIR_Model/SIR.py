...
A_infection_rate_slide=Slider(title="Infection Rate of Unknown Asymptomatics", value=beta_A_uk, start=0, end=1, step=0.01, margin=(10, 5, 0, 20))
social_distancing=Slider(title="Rate of Social Distancing", value=(1-sd), start=0, end=1, step=0.01, margin=(0, 5, 0, 20))
recovery_slider=Slider(title="Rate of Recovery", value=gamma, start=0, end=.5, step=0.01, margin=(0, 5, 0, 20))
