...
def sliders_reaction_kinetics():
    ...
    #bokeh_script_reaction_kinetics = server_document(url="https://srrweb.cc.lehigh.edu/sliders_reaction_kinetics")
...
def SIR():
    bokeh_script_SIR = server_document(url="http://localhost:5005/SIR")
    #bokeh_script_SIER_Model = server_document(url="https://srrweb.cc.lehigh.edu/SIR")
