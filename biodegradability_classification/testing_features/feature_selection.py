...
from bokeh.models import Button, Paragraph, PreText

# Load data from a CSV file
df = pd.read_csv('../biodegrad.csv', low_memory=False)  # Replace with your CSV file path
...
layout = column(button, selected_features_text, result_text)
